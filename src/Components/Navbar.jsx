        ...
        <>  
            <div className='w-full flex justify-between items-center font-semibold'>  
                ...
                <div className='flex items-center gap-2 mt-4'>  
                    <p className='bg-white text-black px-4 py-1 rounded-2xl cursor-pointer'>Explore Menu</p>  
                    <p className='text-white px-4 py-1 rounded-2xl cursor-pointer'>Install</p>  
